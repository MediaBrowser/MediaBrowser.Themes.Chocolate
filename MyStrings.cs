namespace Chocolate
{
    ...
    public class MyStrings : LocalizedStringData
    {
        ...
        public string ShowCoverFlowEndTime = "Show End Time";
        ...
        public string ShowCoverFlowLogos = "Show Logos";
        ...
        public string ShowListEndTime = "Show End Time";
        public string ShowListEndTimeDesc = "This Option Will Show End Time On List View.";
        public string ShowListLogos = "Show Logos";
        ...
        public string ShowThumbEndTime = "Show End Time";
        public string ShowThumbEndTimeDesc = "This Option Will Show End Time On Thumb View.";
        public string ShowThumbLogos = "Show Logos";
